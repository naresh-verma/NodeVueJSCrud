    ...
    <div class="panel">
      <div class="panel-content">
        <div class="form-container" style="text-align: left">
          <div class="back-btn">
            <div>
              <h1 style="text-align: left; margin-right: 10px;">Edit Employee</h1>
            </div>
          ...
          <div class="data-container" v-if="employeeData">
            ...
            <div class="button-group">
                <button class="btn btn-xl btn-update" @click="update">Update</button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    update () {
      this.employeeData.employee_id = this.$route.params.id
      this.$http.put('admin/employee', this.employeeData,
        {
          headers: {
            'authorization': 'Bearer ' + localStorage.getItem('currentUser')
          }
